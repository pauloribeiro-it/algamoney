...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<?> handlerEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String mensagemUsuario = messages.getMessage("recurso.operacao-nao-permitida", null, LocaleContextHolder.getLocale()); 
	...
	private List<Erro> criarListaErros(BindingResult bindingResult){
		...
		for(FieldError fieldErro: bindingResult.getFieldErrors()) {
			String mensagemUsuario = messages.getMessage(fieldErro, LocaleContextHolder.getLocale());
